...
public class EnergyMall  extends Mall{
	ArrayList<EnergyInventory> firmInventories;
	ArrayList<EnergyOrder> orderBook;
	EnergyMall(ContinuousSpace<Object> space, Grid<Object> grid,int mallID,int sectorID){
		super(space,  grid, mallID, sectorID);
		firmInventories = new ArrayList<EnergyInventory>() ;
